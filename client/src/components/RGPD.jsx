...
function RGPD() {
    return (
        <Popup className="popUp"
            ...
            position="top center"
        >
            <div className='RGPDWarning'>Dans le cadre de la règlementation européenne (RGPD), nous prenons en compte vos droits liés à la protection de la vie privée et à la protection de vos données personnelles.<br /><br/>
                Nous donnons la priorité à la confidentialité et à la sécurisation des données que vous nous confiez. Nous traitons vos données à caractère personnel en interne mais, pour des raisons techniques, nous pouvons être amenés à les transmettre à des sous-traitants ou des partenaires qui s'engagent à mettre tout en œuvre pour garantir une sécurité et une confidentialité maximales au traitement de vos données.<br /><br/>
